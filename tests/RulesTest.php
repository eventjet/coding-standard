...
final class RulesTest extends TestCase
{
    ...
    private const SKIPPED_INVALID = [
        ...
        ['space-before-semicolon.php', 'php-cs-fixer'],
        ['array-bracket-spacing.php', 'php-cs-fixer'],
        ['long-type-hint.php', 'php-cs-fixer'],
        ['bracketed-namespace.php', 'php-cs-fixer'],
        ['uppercase-type-hint.php', 'php-cs-fixer'],
        ['forbidden-function-sizeof.php', 'php-cs-fixer'],
        ['deprecated-function.php', 'php-cs-fixer'],
        ['unnecessary-final-modifier.php', 'php-cs-fixer'],
        ...
        ['useless-if-with-return.php', 'php-cs-fixer'],
        ['useless-parentheses.php', 'php-cs-fixer'],
        ['unused-closure-use.php', 'php-cs-fixer'],
        ['self-member-reference.php', 'php-cs-fixer'],
        ['snake-case-variable.php', 'php-cs-fixer'],
        ['uppercase-php-function.php', 'php-cs-fixer'],
        ['forbidden-author-annotation.php', 'php-cs-fixer'],
        ['forbidden-class-comment.php', 'php-cs-fixer'],
        ['inline-doc-comment.php', 'php-cs-fixer'],
        ...
        ['phpdoc-not-trimmed.php', 'phpcs'],
        ['array-not-trimmed.php', 'phpcs'],
        ['whitespace-after-comma.php', 'phpcs'],
        ['union-type-with-spaces.php', 'phpcs'],
    ];
